...
def training(model, x, y):
    ...
    for _ in range(n_steps):
        ...
        indices = torch.randint(0, x.shape[0], (minibatch_size, ))
        x_batch = x[indices]
        y_batch = y[indices]
        ...
        # TODO update params
        #wyłącza mechanizm śledzenia operacji autograd, co umożliwia wykonanie operacji w miejscu na tensorach bez zgłaszania błędu
        with torch.no_grad():
            for p in model.parameters():
